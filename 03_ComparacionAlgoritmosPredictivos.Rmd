...
Referencia: Fuente de datos, dependencia, resolución espacial, resolución temporal y número total de variables descargadas. Variables especificas descargadas de cada uno de los productos satelitales: MODIS-MAIAC (MCD19A2) *Optical_Depth_047* (*Blue band (0.47 μm) aerosol optical depth over land*), MERRA-2 (M2T1NXFLX) *PBLH* (*planetary boundary layer height *), MERRA-2 (M2IMNXGAS) *AODANA* y *AODINC* (*Aerosol Optical Depth Analysis* y *Aerosol Optical Depth Analysis Increment*), VIIRS (VNP14A1) *FireMask* (*Confidence of fire*) y MODIS (MOD11A1/MYD11A1) *LST_Day_1km* y *LST_Night_1km* (*Daytime Land Surface Temperature* y *Nighttime Land Surface Temperature*).
