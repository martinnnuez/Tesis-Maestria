...
#### Base de datos reducida por el algoritmo LASSO
  ...
  En esta sección se desarrolló el modelado predictivo a partir de la base de datos reducida por medio del algoritmo de selección de variables de *LASSO*. La base de datos original quedó reducida a un total de 45 variables predictoras. Los resultados del modelo predictivo desarrollado en esta sección se presentan en las tablas \@ref(tab:modurbtrainLASSO) y \@ref(tab:modurbtestLASSO).
...
#### Base de datos reducida por el algoritmo featurewiz
  ...
  En esta sección se desarrolló el modelado predictivo a partir de una base de datos reducida por medio del algoritmo de selección de variables de *featurewiz*. La base de datos original quedó reducida a un total de 66 variables. Los resultados del modelo predictivo desarrollado en esta sección se presentan en las tablas \@ref(tab:modurbtrainfeat) y \@ref(tab:modurbtestfeat).
...
#### Base de datos reducida por el algortimo de LASSO
  ...
  En esta sección se desarrolló el modelado predictivo a partir de la base de datos reducida por medio del algoritmo de selección de variables de *LASSO*. La base de datos original quedó reducida a un total de 40 variables predictoras. Los resultados del modelo predictivo desarrollado en esta sección se presentan en las tablas \@ref(tab:modaatrainLASSO) y \@ref(tab:modaatestLASSO).
...
#### Base de datos reducida por el algoritmo de featurewiz
  ...
  En esta sección se desarrolló el modelado predictivo a partir de una base de datos reducida por medio del algoritmo de selección de variables de *featurewiz*. La base de datos original quedó reducida a un total de 54 variables. Los resultados del modelo predictivo desarrollado en esta sección se presentan en las tablas \@ref(tab:modaatrainfeat) y \@ref(tab:modaatestfeat).
