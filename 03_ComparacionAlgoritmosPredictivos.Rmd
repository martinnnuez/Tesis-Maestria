...
\begin{equation*}
\text{Pérdida} = \sum_{i=1}^{n} (y_i-\hat{y_i})^2 + \lambda \sum_{i=1}^{n} |w_i| \tag{2}
\end{equation*}
\begin{flushleft}
\setstretch{1}
{\footnotesize
